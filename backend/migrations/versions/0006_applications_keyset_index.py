...
The applications list supports optional stage filtering and paginates on
(created_at, id) DESC. This composite index leads with tenant_id and stage
(matching RLS plus the stage filter) so the keyset
