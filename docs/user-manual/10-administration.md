...
| **Senior Credit Officer** | Everything a Loan Officer can do, plus committee-grade approval of applications and hands-on supervision of the loan book. A senior tier, not an administrator: no access to corrections, settings or access control. Typically given a higher approval limit than the roles it supervises. |
